...
```html
<script src="https://cdn.jsdelivr.net/npm/@binarion/event-bus@1.0.0/dist/event-bus.min.js"></script>
```

or

```html
<script src="https://unpkg.com/@binarion/event-bus@1.0.0/dist/event-bus.min.js"></script>
```
